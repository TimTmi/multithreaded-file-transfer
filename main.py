...
class ProgressWindow(ctk.CTkToplevel):
    def __init__(self, master, title: str, main_label_text: str, bar_count: int, goal: int, auto_close_time: int = 2, **kwargs):
        super().__init__(master, **kwargs)
        ...
        if auto_close_time is not None:
            self.after(auto_close_time * 1000, self.close_window)
